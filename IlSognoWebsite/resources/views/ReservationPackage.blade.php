                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="text-primary description-text">Package Availed: </h5> <h5 class="description-text">Barkada Package</h5><br><br>
                                        <p class="description-text text-primary">Package Duration:</p> <p class="description-text">1</p><br>
                                        <p class="description-text text-primary">Package Pax:</p> <p class="description-text">1</p><br>
                                        <p class="description-text text-primary">Package Rate:</p> <p class="description-text">1</p><br>
                                        <p class="description-text text-primary">Package Description:</p> <p class="description-text">1</p><br>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <ul class="nav nav-tabs nav-tabs-neutral justify-content-center text-center" role="tablist" data-background-color="orange">
                                <li class="nav-item">
                                    <a class="nav-link inactive-link active">
                                        <i class="fa fa-bed"></i> Additional Rooms
                                    </a>
                                </li>
                            </ul>
                            <div class="card-block">
                                <p class="title text-center">You can add additional rooms with your package!</p><br>
                                <div class="row">
                                  <div class="table">
                                        <table class="text-center stretch-element" id="tblAvailableRooms" onclick="run(event, 'AvailableRooms')">
                                            <thead class="text-primary">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#ModalReservationRoom">Add Room</button>
                                    </div>
                                </div>
                            </div>
                        </div>
